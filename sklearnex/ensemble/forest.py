...
class RandomForestClassifier(sklearn_RandomForestClassifier):
    ...
    if sklearn_check_version("1.0"):
        ...
        def __init__(
            ...
            self._daal4py_estimator = daal4py_RandomForestClassifier(
                n_estimators=n_estimators,
                criterion=criterion,
                max_depth=max_depth,
                min_samples_split=min_samples_split,
            ...
            self._onedal4py_estimator = preview_RandomForestClassifier(
                n_estimators=n_estimators,
                criterion=criterion,
                max_depth=max_depth,
                min_samples_split=min_samples_split,
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        dispatch(
            ...
            "fit",
            {
                ...
                "onedal": preview_RandomForestClassifier._onedal_fit,
    ...
    def predict(self, X):
        ...
        return dispatch(
            ...
            "predict",
            {
                ...
                "onedal": preview_RandomForestClassifier._onedal_predict,
    ...
    def predict_proba(self, X):
        ...
        return dispatch(
            ...
            "predict_proba",
            {
                ...
                "onedal": preview_RandomForestClassifier._onedal_predict_proba,
