...
req_device["sklearnex/covariance_spmd.py"] = ["gpu"]
req_device["sklearnex/dbscan_spmd.py"] = ["gpu"]
...
req_device["sklearnex/linear_regression_spmd.py"] = ["gpu"]
...
req_library["sklearnex/covariance_spmd.py"] = ["dpctl", "mpi4py"]
req_library["sklearnex/dbscan_spmd.py"] = ["dpctl", "mpi4py"]
...
req_library["sklearnex/linear_regression_spmd.py"] = ["dpctl", "mpi4py"]
...
req_os["sklearnex/covariance_spmd.py"] = ["lnx"]
req_os["sklearnex/dbscan_spmd.py"] = ["lnx"]
...
req_os["sklearnex/linear_regression_spmd.py"] = ["lnx"]
