...
gen_examples = [
    ('adaboost_batch', None, None, (2022, 0)),
    ...
    ('bf_knn_classification_batch', None, None),
    ('brownboost_batch', None, None, (2022, 0)),
    ...
    ('log_reg_dense_batch',),
    ('logitboost_batch', None, None, (2022, 0)),
    ...
    ('sorting_batch',),
    ('stump_classification_batch', None, None, (2022, 0)),
    ('stump_regression_batch', None, None, (2022, 0)),
