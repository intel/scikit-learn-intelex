...
class Base():
    ...
    def test_svm(self):
        testdata = np_read_csv(os.path.join(unittest_data_path, "svm.csv"),
                               range(1))
        import svm as ex
...
gen_examples = [
    ...
    ('correlation_distance', 'correlation_distance.csv',
    ...
    ('cosine_distance', 'cosine_distance.csv',
    ...
    ('decision_forest_regression_default_dense',
     'decision_forest_regression.csv', lambda r: r[1].prediction, (2023, 'P', 1)),
    ...
    ('decision_forest_regression_hist',
     'decision_forest_regression_20230101.csv',
     lambda r: r[1].prediction, (2023, 'P', 101)),
    ('decision_tree_classification', 'decision_tree_classification.csv',
     lambda r: r[1].prediction),
    ('decision_tree_regression', 'decision_tree_regression.csv',
     lambda r: r[1].prediction),
    ...
    ('linear_regression', 'linear_regression.csv',
     lambda r: r[1].prediction),
    ('linear_regression_streaming', 'linear_regression.csv',
     lambda r: r[1].prediction),
    ...
    ('low_order_moms_dense', 'low_order_moms_dense.csv',
    ...
    ('low_order_moms_streaming', 'low_order_moms_dense.csv',
     lambda r: np.vstack((r.minimum, r.maximum, r.sum, r.sumSquares,
                          r.sumSquaresCentered, r.mean, r.secondOrderRawMoment,
                          r.variance, r.standardDeviation, r.variation))),
    ('multivariate_outlier', 'multivariate_outlier.csv',
    ...
    ('ridge_regression_streaming', 'ridge_regression.csv',
