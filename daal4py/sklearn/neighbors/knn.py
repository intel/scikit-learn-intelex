...
class KNeighborsMixin(BaseKNeighborsMixin):
    def kneighbors(self, X=None, n_neighbors=None, return_distance=True):
        ...
        if daal_check_version(((2020,'P', 3),(2021,'P', 200))) and fit_X_correct_type and self._fit_method in ['brute', 'kd_tree', 'auto'] \
...
class KNeighborsClassifier(BaseKNeighborsClassifier, KNeighborsMixin):
    def fit(self, X, y):
        ...
        if daal_check_version(((2020,'P', 3),(2021,'P', 200))) and not X_incorrect_type \
    ...
    def predict(self, X):
        ...
        if daal_check_version(((2020,'P', 3),(2021,'P', 200))) and hasattr(self, 'daal_model_') \
        and self.weights in ['uniform', 'distance'] and self.algorithm in ['brute', 'kd_tree', 'auto'] \
        and (self.metric == 'minkowski' and self.p == 2 or self.metric == 'euclidean') \
