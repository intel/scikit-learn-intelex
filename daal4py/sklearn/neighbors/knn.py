...
from .._utils import getFPType, daal_check_version, getLogStr, make2d
...
class KNeighborsClassifier(BaseKNeighborsClassifier, KNeighborsMixin):
    def fit(self, X, y):
        ...
        and single_output and fptype is not None and not sp.issparse(X) and numeric_type:
            logging.info("sklearn.neighbors.KNeighborsClassifier.fit: " + getLogStr("daal"))
            ...
            logging.info("sklearn.neighbors.KNeighborsClassifier.fit: " + getLogStr("sklearn"))
