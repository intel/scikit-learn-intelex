...
def compare_with_sklearn_tsne(early_exaggeration=12.0, learning_rate=200,
    ...
    # Models
    sklearn_model = sklearn_TSNE(early_exaggeration=early_exaggeration, learning_rate=learning_rate,
                                 min_grad_norm=min_grad_norm, angle=angle)
    
    daal_model = daal_TSNE(early_exaggeration=early_exaggeration, learning_rate=learning_rate,
                                 min_grad_norm=min_grad_norm, angle=angle)
    ...
    # Divergence
    sklearn_model_divergence = sklearn_model.kl_divergence_
    daal_model_divergence = daal_model.kl_divergence_
    ratio = daal_model_divergence / sklearn_model_divergence
    reason = describe +        f"daal_divergence = {daal_model_divergence}, sklearn_divergence = {sklearn_model_divergence}"
    ...
    reason = describe +        f"daal_n_iter = {daal_model_n_iter}, sklearn_n_iter = {sklearn_model_n_iter}"
...
def test_learning_rate(min_grad_norm):
    compare_with_sklearn_tsne(
