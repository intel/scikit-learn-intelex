...
if [ "$sklearn_version" == "main" ]; then
    ...
    sed -i.bak -e "s/scikit-learn==1.3.2/scikit-learn/" requirements-test.txt
    ...
    sed -i.bak -e "s/scikit-learn==1.3.2/scikit-learn==${sklearn_version}.*/" requirements-test.txt
fi
