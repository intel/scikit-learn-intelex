    ...
    def fit(self, X, y, queue):
        ...
        if self.n_components < n_sf_min:
            if self.explained_variance_.shape[0] == n_sf_min:
                self.noise_variance_ = self.explained_variance_[self.n_components:].mean()
            else:
        ...
        #TODO: find out what should we do with these attributes
        self.n_features_in_ = "Not supported yet"
