...
#include "onedal/data_management/heterogen_table/heterogen_table.hpp"
...
ONEDAL_PY_INIT_MODULE(data_management) {
    ...
    data_management::instantiate_chunked_array(sub_module);
    ...
    data_management::instantiate_heterogen_table(sub_module);
}
