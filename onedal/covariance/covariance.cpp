...
ONEDAL_PY_INIT_MODULE(covariance) {
    ...
    auto sub = m.def_submodule("covariance");
        ...
        ONEDAL_PY_INSTANTIATE(init_partial_compute_ops, sub, policy_list_spmd, task::compute);
        ONEDAL_PY_INSTANTIATE(init_finalize_compute_ops, sub, policy_list_spmd, task::compute);
    #else    
