...
# daal4py Stump example for shared memory systems
...
def main(readcsv=read_csv, method='defaultDense'):
    ...
    # Configure a stump training object
    train_algo = d4p.stump_training()
    ...
    predict_algo = d4p.stump_prediction()
...
if __name__ == "__main__":
    ...
    print("Stump classification results: (first 20 observations):\n", predict_result.prediction[:20])
