...
- `Single-Process Decision Forest Classification Default Dense method
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_forest_classification_default_dense.py>`__
- `Single-Process Decision Forest Classification Histogram method
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_forest_classification_hist.py>`__
...
- `Single-Process Decision Tree Classification
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_tree_classification.py>`__
...
- `Single-Process Gradient Boosted Classification
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/gradient_boosted_classification.py>`__
...
- `Single-Process kNN
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/kdtree_knn_classification.py>`__
...
- `Single-Process AdaBoost Classification
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/adaboost.py>`__
...
- `Single-Process BrownBoost Classification
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/brownboost.py>`__
...
- `Single-Process LogitBoost Classification
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/logitboost.py>`__
...
- `Single-Process Stump Weak Learner Classification
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/stump_classification.py>`__
...
- `Single-Process Naive Bayes <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/naive_bayes.py>`__
...
- `Single-Process SVM
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/svm.py>`__
...
- `Single-Process Binary Class Logistic Regression
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/log_reg_binary_dense.py>`__
- `Single-Process Logistic Regression
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/log_reg_dense.py>`__
...
- `Single-Process Decision Forest Regression Default Dense method
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_forest_regression_default_dense.py>`__
- `Single-Process Decision Forest Regression Histogram method
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_forest_regression_hist.py>`__
...
- `Single-Process Decision Tree Regression
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_tree_regression.py>`__
...
- `Single-Process Boosted Regression Regression
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/gradient_boosted_regression.py>`__
...
- `Single-Process Linear Regression <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/linear_regression.py>`__
...
- `Single-Process LASSO Regression <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/lasso_regression.py>`__
...
- `Single-Process Ridge Regression <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/ridge_regression.py>`__
...
- `Single-Process Stump Regression
  <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/stump_regression.py>`__
...
- `Single-Process PCA <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/pca.py>`__
...
- `Single-Process PCA Transform <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/pca_transform.py>`__
...
- `Single-Process K-Means <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/kmeans.py>`__
...
- `Single-Process DBSCAN <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/dbscan.py>`__
...
- `Single-Process Multivariate Outlier Detection <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/multivariate_outlier.py>`__
...
- `Single-Process Univariate Outlier Detection <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/univariate_outlier.py>`__
...
- `Single-Process Bacon Outlier Detection <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/bacon_outlier.py>`__
...
.. rubric:: Examples:
- `In Adagrad <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/adagrad_mse.py>`__
- `In LBFGS <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/lbfgs_mse.py>`__
- `In SGD <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/sgd_mse.py>`__
...
.. rubric:: Examples:
- `In SGD <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/sgd_logistic_loss.py>`__
...
.. rubric:: Examples:
- `In LBFGS <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/lbfgs_cr_entr_loss.py>`__
...
.. rubric:: Examples:
- `Using Logistic Loss <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/sgd_logistic_loss.py>`__
- `Using MSE <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/sgd_mse.py>`__
...
.. rubric:: Examples:
- `Using MSE <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/lbfgs_mse.py>`__
...
.. rubric:: Examples:
- `Using MSE <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/adagrad_mse.py>`__
...
.. rubric:: Examples:
- `Single Proces saga-logistc_loss <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/saga.py>`__
...
- `Single-Process Cosine Distance <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/cosine_distance.py>`__
...
- `Single-Process Correlation Distance <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/correlation_distance.py>`__
...
- `Single-Process Expectation-Maximization <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/em_gmm.py>`__
...
- `Single-Process QR <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/qr.py>`__
...
- `Single-Process Pivoted QR <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/pivoted_qr.py>`__
...
- `Single-Process Z-Score Normalization <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/normalization_zscore.py>`__
...
- `Single-Process Min-Max Normalization <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/normalization_minmax.py>`__
...
- `Single-Process Bernoulli Distribution <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/distributions_bernoulli.py>`__
...
- `Single-Process Normal Distribution <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/distributions_normal.py>`__
...
- `Single-Process Uniform Distribution <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/distributions_uniform.py>`__
...
- `Single-Process Association Rules <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/association_rules.py>`__
...
- `Single-Process Cholesky <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/cholesky.py>`__
...
- `Single-Process Covariance <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/covariance.py>`__
...
- `Single-Process implicit ALS <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/implicit_als.py>`__
...
- `Single-Process Low Order Moments <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/low_order_moms_dense.py>`__
...
- `Single-Process Quantiles <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/quantiles.py>`__
...
- `Single-Process SVD <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/svd.py>`__
...
- `Single-Process Sorting <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/sorting.py>`__
...
- `Decision Forest Regression <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_forest_regression_traverse.py>`__
- `Decision Forest Classification <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_forest_classification_traverse.py>`__
- `Decision Tree Regression <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_tree_regression_traverse.py>`__
- `Decision Tree Classification <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/decision_tree_classification_traverse.py>`__
- `Gradient Boosted Trees Regression <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/gradient_boosted_regression_traverse.py>`__
- `Gradient Boosted Trees Classification <https://github.com/intel/scikit-learn-intelex/tree/master/examples/daal4py/gradient_boosted_classification_traverse.py>`__
