...
---------------------------------
daal4py oneAPI and GPU support deprecated - please use scikit-learn-intelex 
instead -  https://intel.github.io/scikit-learn-intelex/oneapi-gpu.html#
...
daal4py package avaialbe on same channels and platforms as scikit-learn-intelex, please 
refer to 
...
-----------------------------
.. note::
    Recommended flow for scikit-lear patching is through use of the 
    'scikit-learn-intelex package patching <https://intel.github.io/scikit-learn-intelex/what-is-patching.html>' _
