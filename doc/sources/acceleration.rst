...
You can also try out the benchmarks used to create this data by going to Intel’s `scikit-learn_bench <https://github.com/IntelPython/scikit-learn_bench>`_ repository and following the relevant instructions.
